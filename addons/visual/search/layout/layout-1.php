...
if ( $nd_rst_arrow != '') {
  $nd_rst_image = $nd_rst_arrow[0];
}else{
  $nd_rst_image = esc_url(plugins_url('icon-down-grey.png', __FILE__ ));
}


$nd_rst_customizer_color_dark_1 = get_option( 'nd_rst_customizer_color_dark_1', '#2d2d2d' );

$nd_rst_search1_datep_style = '.nd_rst_component_search_cal_l_1.ui-datepicker {  background-color: '.$nd_rst_customizer_color_dark_1.'; }';
...
$str .= '
    ...
    <div class="nd_rst_section nd_rst_component_search_l1 '.$nd_rst_class.' ">
        ...
        <form action="'.$nd_rst_action.'" method="get">
            ...
            <div class="nd_rst_width_66_percentage nd_rst_width_100_percentage_all_iphone nd_rst_float_left nd_rst_padding_30 nd_rst_box_sizing_border_box nd_rst_bg_white">
                ...
                <div class="nd_rst_width_50_percentage nd_rst_width_100_percentage_all_iphone nd_rst_float_left nd_rst_box_sizing_border_box">
                    ...
                    <div id="nd_rst_open_calendar_from" class="nd_rst_section nd_rst_box_sizing_border_box nd_rst_text_align_center nd_rst_cursor_pointer">
                      <div class="nd_rst_section  nd_rst_box_sizing_border_box nd_rst_text_align_center">
                        <p style="color:'.$nd_rst_text_color.'" class="nd_rst_letter_spacing_2">'.__('SET DATE','nd-restaurant-reservations').' :</p>
                        ...
                        <div class="nd_rst_display_inline_flex ">
                          ...
                          <div class="nd_rst_float_left nd_rst_text_align_right">
                            <h1 style="color:'.$nd_rst_number_color.'" id="nd_rst_date_number_from_front" class="nd_rst_font_size_50 nd_options_color_greydark">'.$nd_rst_date_number_from_front.'</h1>
                          </div>
                          
                          <div class="nd_rst_float_right nd_rst_text_align_center nd_rst_margin_left_10">
                              <h6 style="color:'.$nd_rst_text_color.'" id="nd_rst_date_month_from_front" class="nd_options_color_grey nd_rst_margin_top_2 nd_rst_font_size_12">'.$nd_rst_date_month_from_front.'</h6>
                ...
                <div class="nd_rst_width_50_percentage nd_rst_margin_top_20_all_iphone nd_rst_width_100_percentage_all_iphone nd_rst_float_left  nd_rst_box_sizing_border_box">
                    <div class="nd_rst_section  nd_rst_box_sizing_border_box nd_rst_text_align_center">
                      <div class="nd_rst_section  nd_rst_box_sizing_border_box nd_rst_text_align_center">
                        <p style="color:'.$nd_rst_text_color.'" class="nd_rst_letter_spacing_2 nd_rst_margin_top_20_all_iphone">'.__('GUESTS','nd-restaurant-reservations').' :</p>
                        <div class="nd_rst_section nd_rst_height_15"></div> 
                        <div class="nd_rst_display_inline_flex ">
                          <div class="nd_rst_float_left nd_rst_text_align_right">
                              <h1 style="color:'.$nd_rst_number_color.'" class="nd_rst_font_size_50 nd_rst_color_greydark nd_rst_guests_number nd_rst_min_width_35 nd_rst_text_align_center">1</h1>
                          </div>
                          <div class="nd_rst_float_right nd_rst_text_align_center nd_rst_margin_left_10">
            ...
            <div class="nd_rst_width_33_percentage nd_rst_width_100_percentage_all_iphone nd_rst_padding_30 nd_rst_padding_top_0_all_iphone nd_rst_box_sizing_border_box nd_rst_width_100_percentage_all_iphone nd_rst_float_left nd_rst_text_align_center nd_rst_bg_greydark">
                ...
                <input style="padding: '.$nd_rst_submit_padding.'; background-color:'.$nd_rst_submit_bg.'; margin-top: '.$nd_rst_submit_margin_top.'px;" class="nd_rst_margin_top_0_important_all_iphone nd_options_color_white nd_options_second_font_important nd_rst_width_100_percentage nd_rst_border_width_0_important nd_rst_letter_spacing_2" type="submit" value="'.__('BOOK','nd-restaurant-reservations').'">
